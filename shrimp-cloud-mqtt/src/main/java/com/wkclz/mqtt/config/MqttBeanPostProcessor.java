...
public class MqttBeanPostProcessor implements BeanPostProcessor, ApplicationListener<ContextRefreshedEvent> {
	...
	public void onApplicationEvent(ContextRefreshedEvent event) {
		...
		parentTopicSet.forEach(parentTopic -> {
            ...
            try {
                ...
                mqttClient.subscribe(parentTopic + "/#", 1, new IMqttMessageListener() {
                    @Override
